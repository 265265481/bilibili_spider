...
def read_bvids_from_excel(file_path, start_row=1, end_row=None):
    try:
        ...
        if df.shape[1] < 4:  # BV号在第四列，所以至少需要4列
...
def main():
    ...
    for i, bvid in enumerate(remaining_bvids, 1):
        ...
        DEFAULT_AI_SUMMARY_VIDEO_SLEEP = 20
